...
### Database & Storage
*   **Relational Database**: **PostgreSQL (Supabase)** ☁️.
*   **Persistent plant and user data**.

## 7. User-Facing Features
| Category | New Features in v2.0 |
| :--- | :--- |
| **Dashboard** | ✅ **Digital Twin Cards** (Health Rings), ✅ **Weather Integration**, ✅ **Daily Care Tips** |
| **Plant Profile** | ✅ **Growth Charts** (Height over time), ✅ **Vital Signs Grid** (Water/Heat/Disease), ✅ **History Gallery** |
| **Diagnosis** | ✅ **AI Disease Scanning**, ✅ **Risk Assessment**, ✅ **Treatment Recommendations** |
| **Automation** | ✅ **Smart Reminders**, ✅ **Auto-Pilot Mode** (Rain Skips), ✅ **Heat Emergency Alerts** |
| **Experience** | ✅ **Professional UI**, ✅ **Dark/Light Mode Support**, ✅ **Glassmorphism Effects** |
